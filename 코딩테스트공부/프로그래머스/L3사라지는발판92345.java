...
public class L3사라지는발판92345 {
    ...
    public static void main(String[] args) {
        // System.out.println(solution(new int[][]{{1,1,1},{1,0,1},{1,1,1}}, new
        // int[]{1,0}, new int[]{1,2}));
        System.out.println(solution(new int[][] { { 1, 1, 1, 0 }, { 1, 1, 0, 1 }, { 1, 0, 1, 1 }, { 0, 1, 1, 1 } },
